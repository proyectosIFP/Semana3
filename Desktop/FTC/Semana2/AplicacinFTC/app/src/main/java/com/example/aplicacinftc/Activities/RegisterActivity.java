...
public class RegisterActivity extends AppCompatActivity {
    ...
    private String email, nombre, apellidos, edad, contraseña, repetirContraseña, stringFoto;
                    ...
                    mDataBase.child("Users").child(id).setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task2) {
                            if (task2.isSuccessful()) {
                                Toast.makeText(getApplication(), "EMPLEADO REGISTRADO", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(RegisterActivity.this, LoginActivity.class));
                                finish();
                            } else {
